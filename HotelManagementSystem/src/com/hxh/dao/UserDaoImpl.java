 ...
 */
	public List<OrederBean> queryAllUser(String name) throws ClassNotFoundException, Exception {
...
//			读取sql语句
	...
	public List<OrederBean> queryAllUsers() throws ClassNotFoundException, Exception {
		// TODO Auto-generated method stub
//		Connection conn = DBUtil.getConn();
			ArrayList<OrederBean> list =new ArrayList();
			JDBC jdbc=new JDBC();
