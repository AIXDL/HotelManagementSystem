                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room_item-1">
                                ...
                                <h2><a href="car.jsp">家庭房</a></h2>

                                <div class="img">
                                    <a href="car.jsp"><img src="images/room/grid/img-1.jpg" alt=""></a>
                                </div>
                                ...
                                <div class="bot">
                                    ...
                                    <a href="car.jsp" class="awe-btn awe-btn-13">订购</a>
                                </div>
...
if(start==-1){
    ...
    for(var i=0;i<4;i++){
        document.getElementsByClassName("room_item-1")[i].getElementsByTagName("a")[0].href="car.jsp?"+user
        document.getElementsByClassName("room_item-1")[i].getElementsByTagName("a")[1].href="car.jsp?"+user
        document.getElementsByClassName("room_item-1")[i].getElementsByTagName("a")[2].href="car.jsp?"+user
