...
var user= srcc.substring(start+1,end) 
 if(start=="-1"){
    ...
    document.getElementById("register").href="index.jsp"
    document.getElementById("quit").innerHTML="取消客房"
    document.getElementById("quit").href="quit.jsp?"+user;
    var li= document.getElementsByClassName("menu")[0].getElementsByTagName("li")

    li[0].getElementsByTagName("a")[0].href="index.jsp?"+user
    li[1].getElementsByTagName("a")[0].href="about.jsp?"+user
    li[2].getElementsByTagName("a")[0].href="room.jsp?"+user
    li[3].getElementsByTagName("a")[0].href="restaurants.jsp?"+user
   
    li[4].getElementsByTagName("a")[0].href="contact.jsp?"+user
 }