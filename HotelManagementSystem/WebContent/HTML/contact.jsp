                ...
                <div class="contact">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-5">
                            ...
                            <div class="text">
                                <h2>Contact</h2>
                                <p>ACE酒店，位于XXX路上。在这一黄金地段您能亲身感受到XX这一繁华都市高速发展的节奏。从酒店出发步行 5分钟，就可到达国内最繁华的商业街之一XX路。<br> 同样在10分多钟的路程内，客人就可以到达人民广场，那里有XX博物馆、XX大剧院和市政府大厦，或从酒店往南步行十多分钟，就是XX另一条繁华的商业街——XX路及其周围的商务区。</p><br>
                                <ul>
                        ...
                        <div class="col-md-6 col-lg-6 col-lg-offset-1">
                            <div class="contact-form">
                                <form id="send-contact-form" action="../LeaveMessage" method="post">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <input type="text" class="field-text" name="leavename" placeholder="姓名">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="field-text" name="leaveemail" placeholder="邮箱">
                                        </div>
                                        <div class="col-sm-12">
                                            <input type="text" class="field-text" name="leavesubject" placeholder="标题">
                                        </div>
                                        <div class="col-sm-12">
                                            <textarea cols="30" rows="10" name="leavemessage" class="field-textarea" placeholder="写上你的建议"></textarea>
                                        </div>
                                        <div class="col-sm-6">
                                            <button type="submit" class="awe-btn awe-btn-13">发送</button>
                                        </div>
                                    </div>
