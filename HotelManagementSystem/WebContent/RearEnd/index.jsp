...
h1{
	...
	<body>
 	...
 	<c:forEach var="usersAll" items="${usersAll}">
		<tr>
			<td >${usersAll.id}</td>
			<td>${usersAll.user}</td>
			<td>${usersAll.phone}</td>
			<td>${usersAll.startDate}</td>
			<td>${usersAll.endDate}</td>
			<td>${usersAll.room}</td>
			<td class="money">${usersAll.money}</td>
			<td class="status">${usersAll.status}</td>
